...
def cria_menu():
    ...
    canvas.pack()
    canvas.create_image(20,0, anchor=NW, image=logo)#alterar imagem
    ...
    #credenciais_bd = Button(root, text="Configurar credenciais", command= lambda: alterar_crendenciais_bd(root), width=20)
